...
/*   Updated: 2016/07/25 17:18:58 by nbelouni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <stdlib.h>
#include "rtv1.h"
...
t_scene		init_all(void)
{
	...
	cylinder->dir = init_vector(1.0, 0.0, 0);
	cylinder->length = 4.0;
...
//
	...
	cone2->pos = init_vector(0.0, 0.0, 1.0);
	cone2->dir = init_vector(1.0, 0.4, 0.0);
	cone2->len = 1;
	cone2->r = 0.5;
	cone2->color.r = 1;
	cone2->color.g = 0.8;
	...
	light->type = DIRECT;
	light->pos = init_vector(0.0, -5.0, 0.0);
